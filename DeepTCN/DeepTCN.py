...
from DeepTCN.modules import encoder, decoder
from DeepTCN.utils import get_training_sequences_with_covariates, get_training_sequences
from DeepTCN.losses import parametric_loss, nonparametric_loss
...
class DeepTCN():
    ...
    def save_model(self):
        ...
        """
        self.model.save('DeepTCN/deep_tcn_model.h5')
